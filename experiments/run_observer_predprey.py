...
plt.legend()
plt.savefig(folder + "predprey_after_training.pdf", format='pdf')
plt.show()
...
ax = plt.gca()
ax.set_yscale('log')
plt.savefig(folder + "predprey_loss.pdf", format='pdf')
plt.show()
...
plt.plot(t, y_log[0, :, 0], label=r"$y(t)$")
plt.legend()
plt.savefig(folder + "predprey_latent_after_training.pdf", format='pdf')
plt.show()
